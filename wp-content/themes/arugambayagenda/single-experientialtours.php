                        ...
                        <div class="mil-sticky mil-stycky-right mil-p-0-100" data-margin-top="140">
                            ...
                            <div class="mil-book-window">
                                <div>
                                    ...
                                    <div class="mil-field-frame mil-mb-20">
                                        <label>Time</label>
                                        <input id="check-in-time" type="text" class="datepicker-here" data-position="bottom left" placeholder="Select Time" autocomplete="off" readonly="readonly">
                                    </div>
                                    ...
                                    <div class="mil-field-frame mil-mb-20">
                                        ...
                                        <input type="text" id="aru-book-name" placeholder="Enter quantity" value="1">
                                    </div>
