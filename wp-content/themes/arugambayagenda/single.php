...
?>
        ...
        <div class="mil-pub-frame">
            <div class="mil-pub-cover">
                <img src="<?php echo get_template_directory_uri(); ?>/img/blog/1.jpg" alt="cover">
            </div>

            <div class="container mil-p-100-100">
                <div class="row justify-content-center">
                    <div class="col-xl-7">
                        <p class="mil-mb-20 mil-fade-up">Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Felis donec et odio pellentesque. Nisi est sit amet facilisis magna. Semper feugiat nibh sed pulvinar. Id leo in vitae turpis massa sed elementum tempus. Eget est lorem ipsum dolor. Bibendum enim facilisis gravida neque. Nibh ipsum consequat nisl vel. Luctus venenatis lectus magna fringilla urna porttitor rhoncus dolor. Fermentum dui faucibus in ornare quam viverra. Mi quis hendrerit dolor magna eget est. Nunc faucibus a pellentesque sit amet. Donec pretium vulputate sapien nec sagittis aliquam. Ullamcorper sit amet risus nullam eget. Nulla aliquet porttitor lacus luctus accumsan tortor.</p>

                        <p class="mil-mb-20 mil-fade-up">Vestibulum lectus mauris ultrices eros. Pharetra massa massa ultricies mi quis hendrerit dolor magna eget. Sit amet nisl purus in mollis nunc sed. Aenean euismod elementum nisi quis eleifend.</p>

                        <p class="mil-mb-40 mil-fade-up">Pulvinar neque laoreet suspendisse interdum consectetur libero. Urna id volutpat lacus laoreet non curabitur gravida arcu ac. Varius morbi enim nunc faucibus. Ornare suspendisse sed nisi lacus sed viverra tellus in. Massa tincidunt dui ut ornare lectus sit amet. Suspendisse sed nisi lacus sed viverra tellus in. Dapibus ultrices in iaculis nunc sed augue lacus viverra. Velit dignissim sodales ut eu sem integer vitae. At elementum eu facilisis sed odio. Vulputate dignissim suspendisse in est ante in nibh. Ante in nibh mauris cursus mattis molestie a iaculis. Augue neque gravida in fermentum et sollicitudin ac. Pellentesque elit eget gravida cum sociis. In fermentum et sollicitudin ac. Leo integer malesuada nunc vel risus commodo viverra maecenas.</p>
                        <div class="mil-img mil-img-hori mil-mb-40 mil-fade-up">
                            <img src="<?php echo get_template_directory_uri(); ?>/img/services/1.jpg" alt="img">
                        </div>
                        <p class="mil-mb-20 mil-fade-up">Et netus et malesuada fames ac turpis egestas integer eget. Etiam erat velit scelerisque in dictum non consectetur a. Orci phasellus egestas tellus rutrum tellus pellentesque. Amet massa vitae tortor condimentum lacinia quis vel eros donec.</p>
                        <p class="mil-mb-40 mil-fade-up">Morbi tincidunt ornare massa eget egestas purus viverra accumsan in. Eget lorem dolor sed viverra ipsum nunc aliquet. Enim blandit volutpat maecenas volutpat blandit aliquam etiam. Nunc non blandit massa enim nec dui nunc. Enim neque volutpat ac tincidunt vitae semper quis lectus nulla. Fermentum dui faucibus in ornare quam viverra. Porta nibh venenatis cras sed felis eget. Id faucibus nisl tincidunt eget nullam non. Venenatis a condimentum vitae sapien. At volutpat diam ut venenatis tellus in metus vulputate. Ullamcorper morbi tincidunt ornare massa eget egestas. Mi in nulla posuere sollicitudin aliquam ultrices sagittis orci a. Eget nullam non nisi est. Ornare arcu odio ut sem. Vitae auctor eu augue ut lectus arcu bibendum. Aliquet nibh praesent tristique magna sit amet purus gravida quis.</p>

                        <blockquote class="mil-mb-40 mil-fade-up">Et netus et malesuada fames ac turpis egestas integer eget. Etiam erat velit scelerisque in dictum non consectetur a. Orci phasellus egestas tellus rutrum tellus pellentesque. Amet massa vitae tortor condimentum lacinia quis vel eros donec.</blockquote>

                        <p class="mil-mb-100 mil-fade-up">Aliquet porttitor lacus luctus accumsan tortor posuere ac. Nunc consequat interdum varius sit amet. Massa tincidunt dui ut ornare lectus sit amet est placerat. Suscipit adipiscing bibendum est ultricies integer quis. Diam sit amet nisl suscipit. Amet cursus sit ado sed egestas egestas fringilla phasellus faucibus scelerisque. Volutpat lacus laoreet non curabitur gravida arcu. Non curabitur gravida arcu ac tortor dignissim convallis aenean.</p>
                        <div class="mil-divider mil-mb-100"></div>
                        <h2 class="mil-row-title mil-fade-up mil-mb-100">Comments <span class="mil-badge">5</span></h2>
                        <ul class="mil-comments mil-mb-100">
                            <li class="mil-comment mil-mb-40">
                                <div class="mil-comment-head mil-fade-up">
                                    <div class="mil-author">
                                        <div class="mil-avatar">
                                            <img src="<?php echo get_template_directory_uri(); ?>/img/faces/1.jpg" alt="portrait">
                                        </div>
                                        <div>
                                            <h5>Isla Davis</h5>
                                ...
                                <p class="mil-fade-up">Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been the industry's standard dummy text ever since the 1500s, when an unknown printer took a galley of type and scrambled.</p>
                                ...
                                <ul>
                                    <li class="mil-comment mil-mb-40">
                                        <div class="mil-comment-head mil-fade-up">
                                            <div class="mil-author">
                                                <div class="mil-avatar">
                                                    <img src="<?php echo get_template_directory_uri(); ?>/img/faces/2.jpg" alt="portrait">
                                                </div>
                                                <div>
                                    ...
                                    <li class="mil-comment mil-mb-40">
                                        <div class="mil-comment-head mil-fade-up">
                                            <div class="mil-author">
                                                <div class="mil-avatar">
                                                    <img src="<?php echo get_template_directory_uri(); ?>/img/faces/3.jpg" alt="portrait">
                                                </div>
                                                <div>
                                                    <h5>Harry Wilson</h5>
                                                    <p class="mil-text-sm">30 May, 2022</p>
                            ...
                            <li class="mil-comment mil-mb-40">
                                <div class="mil-comment-head mil-fade-up">
                                    <div class="mil-author">
                                        <div class="mil-avatar">
                                            <img src="<?php echo get_template_directory_uri(); ?>/img/faces/4.jpg" alt="portrait">
                                        </div>
                                        <div>
                                            <h5>Oscar Gagnon</h5>
                                            <p class="mil-text-sm">30 May, 2022</p>
                            ...
                            <li class="mil-comment mil-mb-40">
                                <div class="mil-comment-head mil-fade-up">
                                    <div class="mil-author">
                                        <div class="mil-avatar">
                                            <img src="<?php echo get_template_directory_uri(); ?>/img/faces/5.jpg" alt="portrait">
                                        </div>
                                        <div>
                                            <h5>Harry Wilson</h5>
                                            <p class="mil-text-sm">30 May, 2022</p>
                        ...
                        <a href="#." class="mil-button mil-accent-1 mil-reply">
