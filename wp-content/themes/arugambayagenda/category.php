                ...
                <div class="mil-card mil-mb-40-adapt mil-fade-up">
                        ...
                        <div class="swiper-wrapper">
                            ...
                            <div class="swiper-slide">
                                <div class="mil-card-cover">
                                    <img src="<?php the_field('image_one'); ?>" alt="cover" data-swiper-parallax="-100" data-swiper-parallax-scale="1.1">
                                </div>
                            </div>
                            <?php endif; ?>
                            ...
                            <div class="swiper-slide">
                                <div class="mil-card-cover">
                                    <img src="<?php the_field('image_two'); ?>" alt="cover" data-swiper-parallax="-100" data-swiper-parallax-scale="1.1">
                                </div>
                            </div>
                            <?php endif; ?>
                            ...
                            <div class="swiper-slide">
                                <div class="mil-card-cover">
                                    <img src="<?php the_field('image_three'); ?>" alt="cover" data-swiper-parallax="-100" data-swiper-parallax-scale="1.1">
                                </div>
                            </div>
                            <?php endif; ?>
                        </div>
                    ...
                    <ul class="mil-parameters">
                        <li>
                            ...
                            <div>Adults: <?php the_field('capacity'); ?></div>
                        </li>
                        <li>
                            <div class="mil-icon">
                                <!-- SVG Kids -->
                            </div>
                            <div>Kids: <?php the_field('size'); ?></div>
                        </li>
                    </ul>
                    ...
                    <a href="<?php the_permalink(); ?>">
                        <div class="mil-descr">
                            ...
                            <p class="mil-mb-40 font-16"><?php echo get_the_excerpt(); ?></p>
                            <div class="mil-divider"></div>
                            <div class="mil-card-bottom">
                                <div class="mil-price">
                                    <span class="mil-symbol">$</span>
                                    <span class="mil-number"><?php the_field('price_case_two'); ?></span> /
