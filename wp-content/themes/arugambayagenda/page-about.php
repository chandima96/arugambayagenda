...
?>
        ...
        <div class="team-title">
            <div class="team-arrows">
                <button><i class="fa-solid fa-arrow-left" id="left-arrow"></i></button>
                <button><i class="fa-solid fa-arrow-right" id="right-arrow"></i></button>
            </div>
        </div>
        <div class="team-members">

            <div class="team-member-card">
                <img src="image/member_1.jpeg" alt="">
                <h3>David Elone</h3>
                <p class="margin-bottom-5">React Developer</p>
                <p>0771703811</p>
                <p></p>
                <div class="social-links">
                    <a href="" target="_blank"><svg class="icon" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24">
                            <path
            ...
            <!-- Repeat similar team-member-card blocks for other members -->
        </div>
    </div>
