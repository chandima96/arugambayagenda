...
<?php wp_body_open(); ?>
    ...
    <div class="mil-wrapper">
        ...
        <!-- top panel -->
        <div class="mil-top-panel" style="background-color: #ffffffa3 !important; backdrop-filter: blur(10px) !important;">
            <div class="container">
                <div class="mil-top-panel-content">
                    ...
                    <div class="mil-mobile-menu">
                        ...
                        <a href="https://wa.me/+94726479635" target="_blank" class="mil-button mil-open-book-popup mil-top-panel-btn whatsapp-button" style="background-color: #25D366 !important;">
