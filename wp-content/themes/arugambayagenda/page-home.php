                ...
                <div class="mil-flexbox-custom mil-p-100-60">
                    <div class="mil-iconbox-counter" id="counter-section-1">
                        <div class="counter mil-fade-up">
                            ...
                            <h3><span id="counter-1" data-count="100">0</span> <span class="plus-sign">+</span> </h3>
                            <!-- <h3>100+</h3> -->
                    ...
                    <div class="mil-iconbox-counter" id="counter-section-2">
                        <div class="counter mil-fade-up">
                            ...
                            <h3><span id="counter-2" data-count="100">0</span> <span class="plus-sign">+</span> </h3>                            
                            <!-- <h3>100+</h3> -->
                    ...
                    <div class="mil-iconbox-counter" id="counter-section-3">
                        <div class="counter mil-fade-up">
                            ...
                            <h3><span id="counter-3" data-count="100">0</span> <span class="plus-sign">+</span> </h3>                            
                            <!-- <h3>100+</h3> -->
                            <p>Cooking class</p>
                        </div>
                    </div>
                    <div class="mil-iconbox-counter" id="counter-section-4">
                        <div class="counter mil-fade-up">
                            ...
                            <h3><span id="counter-4" data-count="100">0</span> <span class="plus-sign">+</span> </h3>                            
                            <!-- <h3>100+</h3> -->
                            <p>Day trips</p>
                        </div>
                    </div>
                    <div class="mil-iconbox-counter" id="counter-section-5">
                        <div class="counter mil-fade-up">
                            ...
                            <h3><span id="counter-5" data-count="100">0</span> <span class="plus-sign">+</span> </h3>                            
                            <!-- <h3>100+</h3> -->
