        ...
        <div class="mil-content-pad mil-p-100-100 mil-fade-up margin-top-60">
            <div class="container">
                <div class="mil-text-center">
                    ...
                    <p class="mil-mb-20 mil-fade-up">Island-Wide Transfers & Taxi Services - Arugambay Agenda: “Ride with Us” Wherever you are, wherever you want to go, count on Arugambay Agenda for safe and reliable taxi services. We've got you covered island-wide. Your journey, your way. Book your ride today!</p>
                            ...
                            <div class="swiper-wrapper">
                                ...
                                <div class="swiper-slide">
                                    ...
                                    <div class="mil-review-frame mil-text-center" data-swiper-parallax="-250" data-swiper-parallax-opacity="0">
                                        ...
                                        <p class="mil-fade-up mil-mt-40"><span class="mil-fade-up"><?php the_excerpt(); ?></span></p>
                                    </div>
                                </div>
                                    <?php endwhile; endif; ?>
                                    <?php wp_reset_postdata(); ?>
