            ...
            <div class="container">
                <div class="row justify-content-between">
                    ...
                    <div class="booking-card">
                        ...
                        <p>Selected starting time and date</p>
                        ...
                        <div class="booking-info">
                            ...
                            <div class="booking-info">
                                <?php if ($kids > 0): ?>
                                    <svg width="24" height="24" fill="currentColor" class="bi bi-calendar-event custom-margin-10 icon-color" viewBox="0 0 104.9 122.88" style="enable-background:new 0 0 104.9 122.88" xml:space="preserve"><style type="text/css">.st0{fill-rule:evenodd;clip-rule:evenodd;}</style><g>
